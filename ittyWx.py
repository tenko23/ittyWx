...
def scrape_alerts():
    print("\nChecking (for) alerts...\n"  ,datetime.now().time(), "\n")
    api_data = s.get("https://api.weather.gov/alerts/active/zone/NEC109").json()["features"]  #This is the county alert line... make sure the line below is commented out if a countywide alert is desired.  See readme for info.
    #api_data = s.get("https://api.weather.gov/alerts/active/area/NE").json()["features"]  #This is the statewide alert line... comment out the line above and uncomment this line if a statewide alert is desired.  See readme for info.
    temp = []
    global alerts
...
try:
    ...
    while True:
        ...
        time.sleep(3.7)  #Increase this number in parentheses, to decrease the frequency of web scrapes (in minutes).
