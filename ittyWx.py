...
def scrape_alerts():
    print("\nChecking (for) alerts...\n"  ,datetime.now().time(), "\n")
    api_data = requests.get("https://api.weather.gov/alerts/active/zone/NEC109").json()["features"]  #This is the county alert line... make sure the line below is commented out if a countywide alert is desired.  See readme for info.
