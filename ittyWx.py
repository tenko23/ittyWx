...
def scrape_alerts():
    ...
    #api_data = requests.get("https://api.weather.gov/alerts/active/area/NE").json()["features"]  #This is the statewide alert line... comment out the line above if a statewide alert is desired.  See Readme for info.
    temp = []
    global alerts
